...
export const COMPONENT_PROP_SCHEMAS: Record<string, ComponentPropSchema> = {
    ...
    props: [
      {
        name: 'badgeText',
        type: 'string',
        description: 'Text displayed inside the branding badge at the top right of the section, e.g., "Contact Us". Max 6 words.',
        maxWords: 6,
        required: false,
      },
      {
        name: 'titlePart1',
        type: 'string',
        description: 'The first line or main part of the contact heading, styled in deep dark teal. Max 15 words.',
        maxWords: 15,
        required: true,
      },
      {
        name: 'titlePart2',
        type: 'string',
        description: 'The highlighted italicized part of the contact heading shown below the main header line. Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'description',
        type: 'string',
        description: 'Paragraph body text giving users information about the services, renovations, or inquiry followups. Max 40 words.',
        maxWords: 40,
        required: false,
      },
      {
        name: 'formNameLabel',
        type: 'string',
        description: 'Form input field label for entering the client name, e.g., "Your name". Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'formNamePlaceholder',
        type: 'string',
        description: 'Placeholder helper text shown inside the name input text input. Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'formPhoneLabel',
        type: 'string',
        description: 'Form input field label for entering the phone field, e.g., "Your Phone". Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'formPhonePlaceholder',
        type: 'string',
        description: 'Placeholder text shown inside the telephone form input. Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'formServiceLabel',
        type: 'string',
        description: 'Form select dropdown label for selecting desired home/project services, e.g., "Choose Services". Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Placeholder value shown on the unselected service dropdown option, e.g., "Select Services". Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'array',
        description: 'Dynamic selectable menu service options inside the choose services dropdown. E.g., ["Quick Fix", "Renovation"].',
        required: false,
      },
      {
        name: 'formSubmitText',
        type: 'string',
        description: 'Action trigger text inside the submission button, e.g., "Submit". Max 5 words.',
        maxWords: 5,
        required: true,
      }
    ],
    ...
    props: [
      {
        name: 'tagText',
        type: 'string',
        description: 'Small uppercase tag above the main heading (e.g., CONTACT US). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'title',
        type: 'string',
        description: 'Main greeting/invitation header for the contact section (e.g., Talk to our Sales team). Max 12 words.',
        maxWords: 12,
        required: true,
      },
      {
        name: 'description',
        type: 'string',
        description: 'Supporting paragraph below the header describing what to contact for. Max 35 words.',
        maxWords: 35,
        required: false,
      },
      {
        name: 'emailLabel',
        type: 'string',
        description: 'Label header for the email detail block (e.g., Email Address). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'emailValue',
        type: 'string',
        description: 'Target contact email address value. Max 10 words.',
        maxWords: 10,
        required: false,
      },
      {
        name: 'emailIcon',
        type: 'ReactNode',
        description: 'An optional icon node representing the email address detail.',
        required: false,
      },
      {
        name: 'phoneLabel',
        type: 'string',
        description: 'Label header for the phone number block (e.g., Phone Number). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'phoneValue',
        type: 'string',
        description: 'Target telephone/phone contact number. Max 10 words.',
        maxWords: 10,
        required: false,
      },
      {
        name: 'phoneIcon',
        type: 'ReactNode',
        description: 'An pointer style icon node representing the calling telephone item.',
        required: false,
      },
      {
        name: 'officeLabel',
        type: 'string',
        description: 'Label header for the corporate office location (e.g., Our Office). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'officeValue',
        type: 'string',
        description: 'Physical postal address details. Max 15 words.',
        maxWords: 15,
        required: false,
      },
      {
        name: 'officeIcon',
        type: 'ReactNode',
        description: 'An optional marker icon node representing physical/building address.',
        required: false,
      },
      {
        name: 'nameLabel',
        type: 'string',
        description: 'Input label for the first name element (e.g., Your Name). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Placeholder string inside the first name input field (e.g., Your name). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        name: 'lastNameLabel',
        type: 'string',
        description: 'Input label for the last name element (e.g., Last Name). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Placeholder string inside the last name input field (e.g., Your last name). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Input label for the email address field (e.g., Email address). Max 5 words.',
        maxWords: 5,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Placeholder string inside the email input field (e.g., Your email address). Max 6 words.',
        maxWords: 6,
        required: false,
      },
      {
        name: 'messageLabel',
        type: 'string',
        description: 'Label text for the message input text-area (e.g., Message). Max 4 words.',
        maxWords: 4,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Placeholder string inside the text-area (e.g., Write something...). Max 6 words.',
        maxWords: 6,
        required: false,
      },
      {
        ...
        type: 'string',
        description: 'Call-to-action text inside the submit button (e.g., Submit). Max 3 words.',
        maxWords: 3,
        required: true,
      }
    ],
  ...
  'contact-link-dynamic': {
    ...
    section: 'contact',
    props: [
      { name: 'title', type: 'string', description: 'The title of the contact section.', maxWords: 5, required: true },
      { name: 'description', type: 'string', description: 'The description below the title.', maxWords: 30, required: true },
      { name: 'namePlaceholder', type: 'string', description: 'Placeholder for the name input.', maxWords: 2, required: true },
      { name: 'emailPlaceholder', type: 'string', description: 'Placeholder for the email input.', maxWords: 2, required: true },
      { name: 'messagePlaceholder', type: 'string', description: 'Placeholder for the message textarea.', maxWords: 2, required: true },
      { name: 'buttonText', type: 'string', description: 'The text on the send button.', maxWords: 1, required: true },
      { name: 'imageUrl', type: 'string', description: 'The image URL to display.', required: true },
    ],
  },
    ...
    props: [
      {
        name: 'title',
        type: 'string',
        description: 'The main header title text for the contact section (e.g. "Let’s Talk"). Max 10 words.',
        maxWords: 10,
        required: true,
      },
      {
        name: 'description',
        type: 'string',
        description: 'The introductory paragraph explaining how to reach out. Max 50 words.',
        maxWords: 50,
        required: false,
      },
      {
        name: 'address',
        type: 'string',
        description: 'The postal address displayed under the left-side contact information block. Supports line breaks. Max 30 words.',
        maxWords: 30,
        required: false,
      },
      {
        name: 'email',
        type: 'string',
        description: 'The contact email address shown under the left-side contact info block. Max 15 words.',
        maxWords: 15,
        required: false,
      },
      {
        name: 'nameLabel',
        type: 'string',
        description: 'Label text shown for the Name input field (e.g. "Full Name*"). Max 8 words.',
        maxWords: 8,
        required: true,
      },
      {
        name: 'emailLabel',
        type: 'string',
        description: 'Label text shown for the Email input field (e.g. "E-mail ID*"). Max 8 words.',
        maxWords: 8,
        required: true,
      },
      {
        name: 'companyLabel',
        type: 'string',
        description: 'Label text shown for the Company input field (e.g. "Company Name*"). Max 8 words.',
        maxWords: 8,
        required: false,
      },
      {
        name: 'phoneLabel',
        type: 'string',
        description: 'Label text shown for the Mobile/Phone input field (e.g. "Mobile No.*"). Max 8 words.',
        maxWords: 8,
        required: false,
      },
      {
        name: 'messageLabel',
        type: 'string',
        description: 'Label text shown for the Message textarea input field (e.g. "Message*"). Max 8 words.',
        maxWords: 8,
        required: true,
      },
      {
        name: 'submitButtonText',
        type: 'string',
        description: 'Label text displayed inside the submission action button (e.g. "Submit"). Max 5 words.',
        maxWords: 5,
        required: true,
      },
      {
        name: 'successMessage',
        type: 'string',
        description: 'The inline response feedback shown to the user once the form completes submission. Max 30 words.',
        maxWords: 30,
        required: true,
      }
    ],
